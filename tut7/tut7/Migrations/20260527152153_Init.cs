    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "INT", new DateOnly(1968, 7, 18), "Intel" },
                    { 2, "AMD", new DateOnly(1969, 5, 1), "Advanced Micro Devices" },
                    { 3, "NV", new DateOnly(1993, 4, 5), "NVIDIA" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2025, 1, 10, 0, 0, 0, 0, DateTimeKind.Unspecified), "Gaming Beast", 5, 36, 12.5f },
                    { 2, new DateTime(2025, 2, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), "Office Pro", 12, 24, 8.2f },
                    { 3, new DateTime(2025, 3, 20, 0, 0, 0, 0, DateTimeKind.Unspecified), "Mini Home", 7, 12, 4.7f }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "DDR5-32", 2, 3, "32GB DDR5 RAM kit", "DDR5 32GB" },
                    { "I5-14600K", 1, 1, "14th generation Intel processor", "Intel Core i5 14600K" },
                    { "RTX4080", 3, 2, "NVIDIA graphics card", "RTX 4080" }
                });
